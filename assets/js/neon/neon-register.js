...
*/
		...
		neonRegister.$container.validate({
			rules: {
				...
				password: {
					required: true,
					minlength: $('input#password').attr('data-value-edges').split("|")[0], 
					maxlength: $('input#password').attr('data-value-edges').split("|")[1]
				},
			...
			messages: {
				...
				password: {
					required: $('input#password').attr('data-message-required'),	/*** OC - ADD ***/
					minlength: $('input#password').attr('data-message-edges').split("|")[0],	/*** OC - ADD ***/
					maxlength: $('input#password').attr('data-message-edges').split("|")[1]		/*** OC - ADD ***/
				},
				
				password_confirm: {
					required: $('input#password_confirm').attr('data-message-required'),	/*** OC - ADD ***/
					equalTo: $('input#password_confirm').attr('data-message-not-equal')		/*** OC - ADD ***/
				}
			},
